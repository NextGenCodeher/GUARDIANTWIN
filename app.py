...
def build_gauge_figure(value, title, min_value=0, max_value=100, unit="%", bar_color="#38bdf8"):
    fig = go.Figure(
        go.Indicator(
            mode="gauge+number",
            value=value,
            number={"suffix": unit, "font": {"size": 18, "color": "#f8fbff"}},
            title={"text": title, "font": {"size": 12, "color": "#f8fbff"}},
            gauge={
...
display_data.loc[:, "severity_label"] = (
        ...
        <div class="hero-panel">
            <div style="display:flex; justify-content:space-between; flex-wrap:wrap; gap:1rem;">
                ...
                <div style="display:grid; gap:14px; grid-template-columns: repeat(2, minmax(160px, 1fr)); width:min(520px,100%);">
                    <div style="background: {patient_theme['bg']}; border-radius: 12px; padding: 10px; border:1px solid {patient_theme['color']}; color: {patient_theme['color']}; box-shadow: inset 0 0 0 1px rgba(255,255,255,0.08);">
                        <div style="opacity: 1; font-size: 0.75rem;">Current Severity</div>
                        <div style="font-size: 1.25rem; font-weight: 700; margin: 0.65rem 0; color: {patient_theme['color']}; text-shadow: 0 1px 2px rgba(0,0,0,0.2);">{latest['severity_label']}</div>
                    </div>
                    <div style="background: rgba(255,255,255,0.12); border-radius: 12px; padding: 10px; border:1px solid rgba(255,255,255,0.16);">
                        <div style="opacity: 0.8; font-size: 0.75rem;">Risk Probability</div>
                        <div style="font-size: 1.25rem; font-weight: 700; margin: 0.65rem 0;">{round(latest['risk_probability'],1)}%</div>
                    </div>
                    <div style="background: rgba(255,255,255,0.12); border-radius: 12px; padding: 10px; border:1px solid rgba(255,255,255,0.16);">
                        <div style="opacity: 0.8; font-size: 0.75rem;">Active Models</div>
                        <div style="font-size: 1.25rem; font-weight: 700; margin: 0.65rem 0;">3 monitoring engines</div>
                    </div>
                    <div style="background: rgba(255,255,255,0.12); border-radius: 12px; padding: 10px; border:1px solid rgba(255,255,255,0.16);">
                        <div style="opacity: 0.8; font-size: 0.75rem;">Latest Record</div>
                        <div style="font-size: 1.25rem; font-weight: 700; margin: 0.65rem 0;">{latest['date']}</div>
                    </div>
                </div>
            </div>
        </div>
